...
menu() {
    ...
    echoContent green "YouTube频道：https://www.youtube.com/@aifenxiangdexiaoqie"
    echoContent green "描述：八合一共存脚本\c"
    showInstallStatus
    checkWgetShowProgress
    echoContent red "\n=========================== 推广区============================"
    echoContent red "                                              "
    echoContent green "VPS选购攻略：https://lovetoshare.top/archives/3.html"
    echoContent green "年付10美金VPS推荐：https://my.racknerd.com/aff.php?aff=9734&pid=838"
    echoContent red "=============================================================="
    if [[ -n "${coreInstallType}" ]]; then
        echoContent yellow "1.重新安装"
    else
